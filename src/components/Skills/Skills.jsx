...
const Skills = () => {
  const skillsData = {
    ...
    sqlite: { name: "SQLite3", icon: <SiSqlite />, color: "#40a9ff" },
    mongodb: { name: "MongoDB", icon: <SiMongodb />, color: "#47A248" },
    django: { name: "Django", icon: <SiDjango />, color: "var(--django-color)" },
    react: { name: "React", icon: <FaReact />, color: "#61DAFB" },
    vscode: { name: "VS Code", icon: <VscVscode />, color: "#007ACC" },
    eclipse: { name: "Eclipse", icon: <SiEclipseide />, color: "var(--eclipse-color)" },
    git: { name: "Git", icon: <FaGitAlt />, color: "var(--git-color)" },
    github: { name: "GitHub", icon: <SiGithub />, color: "var(--github-color)" },
