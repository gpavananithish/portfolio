...
const ScrollMouse = ({ text1 = "Scroll down", text2 = "to see more" }) => {
  return (
    <div className="scrollMouseContainer">
      <div className="scrollLabel scrollText1">{text1}</div>
      <div className="scrollLine scrollLineLeft"></div>
      
      <div className="mouseIconWrapper">
        <svg 
        ...
        <div className="mouseWheelAnim"></div>
      </div>

      <div className="scrollLine scrollLineRight"></div>
      <div className="scrollLabel scrollText2">{text2}</div>
    </div>
  );
};
